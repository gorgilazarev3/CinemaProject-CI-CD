...
namespace CinemaProject.Web.Data.Migrations
{
    ...
    [Migration("20230709145128_AddedEmailModel")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CinemaProject.Domain.DomainModels.EmailMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("CinemaProject.Domain.DomainModels.Movie", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CinemaProject.Domain.DomainModels.Order", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CinemaProject.Domain.Relationships.TicketInOrder", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CinemaProject.Domain.DomainModels.Order", b =>
                {
                    b.HasOne("CinemaProject.Domain.Identity.CinemaUser", "TicketHolder")
                        .WithMany()
            ...
            modelBuilder.Entity("CinemaProject.Domain.DomainModels.Ticket", b =>
                {
                    b.HasOne("CinemaProject.Domain.DomainModels.Movie", "Movie")
                        .WithMany()
                        .HasForeignKey("ForMovieId")
            ...
            modelBuilder.Entity("CinemaProject.Domain.Relationships.TicketInOrder", b =>
                {
                    b.HasOne("CinemaProject.Domain.DomainModels.Order", "Order")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("CinemaProject.Domain.Identity.CinemaUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
